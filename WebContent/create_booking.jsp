    ...
    <form action='appointment' method='post'>
        ...
        <div class="form-group f5 " data-fid="f5">
            ...
            <div class="input-group">
                    ...
                    type="text"
                    class="form-control" id="f5" name="patientFirstName"
                    value=""/>
            </div>
        </div>
        <div class="form-group f4 " data-fid="f4">
            ...
            <div class="input-group">
					<span class="input-group-addon left"><i
                            class="glyphicon glyphicon-user"></i> </span> <input
                    type="text"
                    class="form-control" id="f4" name="patientLastName"
                    value=""/>
            </div>
        </div>
        <div class="form-group f8 " data-fid="f8">
            ...
            <div class="input-group">
                ...
                <input type="tel"
                       class="form-control" id="f8" name="patientMobile"
                       value=""
        ...
        <div class="form-group f10 " data-fid="f10">
            <label class="control-label" for="f10">Medicare No</label> <input
                type="text" class="form-control" id="f10"
        ...
        <div class="form-group gaddress f12 " data-fid="f12">
            ...
            <div class="form-group city">
                <label class="control-label sr-only" for="f12_city">City</label>
                <input
            ...
            <div class="form-group state">
                <label class="control-label sr-only" for="f12_state">State
                    / Province / Region</label> <input type="text"
                                                       class="form-control"
...
<script src="jqueryform.com.min.js?ver=v2.1.4&id=jqueryform-62f011"></script>
